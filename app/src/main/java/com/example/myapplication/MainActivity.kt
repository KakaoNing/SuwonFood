...
class MainActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId) {
            R.id.navi_refrigerator -> fragmentManager.replace(R.id.main_frame, home_left_refrigerator()).commit()
            R.id.navi_cookBook -> fragmentManager.replace(R.id.main_frame, home_right_cookbook()).commit()
